...
public class SecondActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        second_back_arrow = findViewById(R.id.second_back_arrow2);
        second_arrow_up = findViewById(R.id.second_arrow_up2);

        second_title = findViewById(R.id.second_title2);
        second_subtitle = findViewById(R.id.second_subtitle2);

        second_rating_number = findViewById(R.id.second_rating_number2);        second_rating_number = findViewById(R.id.second_rating_number2);
        second_rating_number2 = findViewById(R.id.second_rating_number2);
        second_ratingbar = findViewById(R.id.second_ratingbar2);

        more_details = findViewById(R.id.more_details2);

        second_back_arrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SecondActivity2.this, HomeActivity.class);
