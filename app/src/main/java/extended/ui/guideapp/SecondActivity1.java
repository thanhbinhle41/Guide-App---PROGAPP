...
public class SecondActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        second_rating_number = findViewById(R.id.second_rating_number);        second_rating_number = findViewById(R.id.second_rating_number);
        ...
        second_back_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SecondActivity1.this, HomeActivity.class);
        ...
        second_arrow_up.setOnClickListener((view) ->{
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(SecondActivity1.this, pairs);
