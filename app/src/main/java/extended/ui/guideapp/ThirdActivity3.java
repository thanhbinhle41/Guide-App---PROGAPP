...
public class ThirdActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        third_scrollview = findViewById(R.id.third_scrollview3);
        ...
        down_arrow.setOnClickListener((view) -> {
            Intent intetent = new Intent (ThirdActivity3.this, SecondActivity3.class);
        ...
        ///////////////
        // Test slider
        viewPager2 = findViewById(R.id.viewPagerImageSlider3);

        List<SliderItem> sliderItems = new ArrayList<>();
        sliderItems.add(new SliderItem(R.drawable.image_1_3));
        sliderItems.add(new SliderItem(R.drawable.image_2_3));
        sliderItems.add(new SliderItem(R.drawable.image_3_3));
        sliderItems.add(new SliderItem(R.drawable.image_4_3));
        sliderItems.add(new SliderItem(R.drawable.image_5_3));
        sliderItems.add(new SliderItem(R.drawable.image_6_3));
        sliderItems.add(new SliderItem(R.drawable.image_7_3));
