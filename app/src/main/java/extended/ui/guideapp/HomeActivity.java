    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent secondActivity = new Intent(HomeActivity.this, SecondActivity1.class);
        ...
        cardView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent secondActivity = new Intent(HomeActivity.this, SecondActivity2.class);
                startActivity(secondActivity);
            }
        });
        ...
        cardView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent secondActivity = new Intent(HomeActivity.this, SecondActivity3.class);
                startActivity(secondActivity);
            }
        });
